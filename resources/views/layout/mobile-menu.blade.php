    ...
    <div class="container">
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="index.html" rel="home">
                    <img src="{{ asset('logo-dark.svg') }}" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]" alt="CutCode">
                </a>
            </div>
        ...
        <div class="mmenu-inner pt-10">
            ...
            <div class="flex items-center">
                <img src="{{ asset('avatar.jpg') }}" class="w-14 h-14 rounded-full" alt="Данил Шуцкий">
